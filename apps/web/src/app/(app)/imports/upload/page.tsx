...
export default function UploadPage() {
  return (
    <div>
      <PageHeader
        title="آپلود اکسل"
        description="فایل را بارگذاری کنید؛ سیستم بر اساس ستون کوتاژ رکوردها را ایجاد یا از اکسل جدید به‌روز می‌کند."
      />
      <UploadDropzone />
      <div className="mt-6 rounded-2xl border border-blue-100 bg-accent-soft p-4 text-sm text-muted">
        ...
        <ul className="mt-2 list-disc space-y-1 pr-5">
          ...
          <li>فیلدهای خالی از اکسل جدید پر می‌شوند.</li>
          <li>
            اگر مقدار فعلی و اکسل متفاوت باشند، اکسل جدید مرجع است و آن کوتاژها به‌روز می‌شوند؛ در
            پایان لیست آپدیت‌شده‌ها نمایش داده می‌شود.
          </li>
          <li>
