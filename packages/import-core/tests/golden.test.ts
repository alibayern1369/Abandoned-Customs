/**
 * Golden unit tests — mirrored from @metrookeh/validator (15 cases).
 * Behavior must match the validator golden reference.
 */
...
describe('Kootaj matching & File2 NEW vs EXISTING', () => {
  function fakeWb(rows: Record<string, unknown>[]) {
...
describe('Multiple-letter conflict detection', () => {
  function fakeF3(rows: Record<string, unknown>[]) {
